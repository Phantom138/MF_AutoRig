...
pos = {
    ...
    'hand': [[(41.116765324483175, 97.09430919137704, 14.28607787822605), (40.26142164374256, 94.1379203453278, 17.89700126843422), (39.981732368469245, 91.80722713470459, 20.279955625534047), (39.69228772955901, 88.7063357453228, 22.013819880834156)],
...
def test_body(positions=pos):
    ...
    L_hand.create_guides(wrist_pos=positions['wrist_pos'], pos = positions['hand'])
